...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MessView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8MessView11AppDelegate")
...
SWIFT_CLASS("_TtC8MessView7ChatLog")
@interface ChatLog : UITableViewCell
...
SWIFT_CLASS("_TtC8MessView17ChatLogController")
@interface ChatLogController : UIViewController
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified ccolectionView;
...
@interface ChatLogController (SWIFT_EXTENSION(MessView)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UITextFieldDelegate>
...
SWIFT_CLASS("_TtC8MessView15ChatMessageCell")
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified loginOutlet;
...
@interface MessageView (SWIFT_EXTENSION(MessView)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC8MessView10NewMessage")
...
@interface NewMessage (SWIFT_EXTENSION(MessView)) <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
...
SWIFT_CLASS("_TtC8MessView12Registration")
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified registerOutlet;
- (void)viewDidLoad;
- (void)handleSelectProfileImageView;
- (IBAction)registrationButton:(id _Nonnull)sender;
...
@interface Registration (SWIFT_EXTENSION(MessView)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
